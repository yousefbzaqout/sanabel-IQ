                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 10px 30px rgba(79,70,229,0.12);">
                    <tr>
                        <td style="background:linear-gradient(135deg,#4f46e5,#7c3aed);padding:32px 24px;color:#ffffff;">
                            <p style="margin:0 0 8px;font-size:14px;letter-spacing:0.08em;text-transform:uppercase;opacity:0.9;">Sanabel IQ</p>
                            <h1 style="margin:0;font-size:28px;font-family:'Tajawal',Tahoma,Arial,sans-serif;">{{ __('Weekly Progress Summary') }}</h1>
                    ...
                    @foreach ($summary['children'] as $child)
                        <tr>
                            <td style="padding:24px;border-bottom:1px solid #e5e7eb;">
                                <h2 style="margin:0 0 8px;font-size:20px;color:#312e81;font-family:'Tajawal',Tahoma,Arial,sans-serif;">
                                ...
                                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin-top:16px;">
                                    <tr>
                                        <td width="33%" style="padding:12px;background:#eef2ff;border-radius:12px;text-align:center;">
                                            <div style="font-size:24px;font-weight:700;color:#4338ca;">{{ $child['activities_completed'] ?? 0 }}</div>
                                        ...
                                        <td width="33%" style="padding:12px;background:#fef3c7;border-radius:12px;text-align:center;">
                                            <div style="font-size:24px;font-weight:700;color:#b45309;">{{ $child['xp_earned'] ?? 0 }}</div>
                                        ...
                                        <td width="33%" style="padding:12px;background:#ecfdf5;border-radius:12px;text-align:center;">
                                            <div style="font-size:24px;font-weight:700;color:#047857;">{{ $child['quiz_accuracy_percent'] ?? 0 }}%</div>
                                            <div style="font-size:12px;color:#4b5563;">{{ __('Quiz Accuracy') }}</div>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <p style="margin:20px 0 0;text-align:center;">
                                    <a href="{{ $child['analytics_url'] ?? route('parent.analytics') }}" style="display:inline-block;background:#4f46e5;color:#ffffff;text-decoration:none;padding:12px 24px;border-radius:9999px;font-weight:600;font-family:'Tajawal',Tahoma,Arial,sans-serif;">
                                        {{ __('View Analytics Dashboard') }}
                                    </a>
                                </p>
                            </td>
                        </tr>
